...
class SiteController extends Controller
{
    ...
    {
        // El código que se ejecuta para mostrar la vista del área de administración
        return $this->render('area-administracion');
    }

    public function actionAreaModerador()
    {
        // Solo los moderadores pueden acceder a esta acción
        if (Yii::$app->user->isGuest || !Usuario::tieneRol(Yii::$app->user->id, Usuario::ROL_MODERADOR)) {
            Yii::$app->user->logout();
