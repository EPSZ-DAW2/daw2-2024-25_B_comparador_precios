...
$this->title = 'Ver Comentario de Artículo';
?>
<div class="comentario-ver">
    ...
    <p>
        <?= Html::a('Editar', ['editar-comentario-articulo', 'id' => $comentario->id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Eliminar', ['eliminar-comentario-articulo', 'id' => $comentario->id], [
