...
<?= $form->field($aviso, 'usuario_destino_id')->textInput() ?>

<?= $form->field($aviso, 'usuario_destino_nick')->textInput(['value' => $aviso->usuario_destino_nick ?: '']) ?>
...
<div class="form-group">
    <?= Html::submitButton($aviso->isNewRecord ? 'Crear' : 'Actualizar', [
        'class' => $aviso->isNewRecord ? 'btn btn-success' : 'btn btn-primary',
    ]) ?>
</div>
