            ...
            [
                ...
                'buttons' => [
                    ...
                    'delete' => function ($url, $model) {
                        return Html::a('Eliminar', ['eliminar-articulo-tienda', 'id' => $model->articulo_id], [
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                        return Html::a('Ver', ['ver-comentario-tienda', 'id' => $model->id], ['class' => 'btn btn-info btn-sm']);
                    },
                    'update' => function ($url, $model) {
                        return Html::a('Editar', ['editar-comentario-tienda', 'id' => $model->id], ['class' => 'btn btn-primary btn-sm']);
                    },
                    'delete' => function ($url, $model) {
                        return Html::a('Eliminar', ['eliminar-comentario-tienda', 'id' => $model->id], [
                            'class' => 'btn btn-danger btn-sm',
                            'data' => [
