...
<div class="comentario-crear">
    ...
    <div class="comentario-form">
        ...
        <!-- Campo oculto para tienda_id -->
        <?= Html::activeHiddenInput($comentario, 'tienda_id') ?>

        <!-- Campo oculto para articulo_id, solo si está presente -->
        <?php if ($comentario->articulo_id): ?>
            <?= Html::activeHiddenInput($comentario, 'articulo_id') ?>
        <?php endif; ?>
