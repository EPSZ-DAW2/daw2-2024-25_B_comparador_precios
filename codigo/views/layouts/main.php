...
$this->registerCssFile('@web/css/gestiondenuncias.css', ['depends' => [\yii\web\YiiAsset::class]]);
...
$this->registerCssFile('@web/css/comentariosarticulostienda.css', ['depends' => [\yii\web\YiiAsset::class]]);
$this->registerCssFile('@web/css/botonesadminprivado.css', ['depends' => [\yii\web\YiiAsset::class]]);
