...
<div class="site-index" style="margin-top: 10px;">
    <div class="jumbotron">
        ...
        <!-- Mensaje y botones de inicio de sesión y registro o mensaje de bienvenida -->
        <div class="call-to-action">
            ...
            <?php else: ?>
                <h3>¡Bienvenido, <?= Yii::$app->user->identity->username ?>!</h3>
                <div class="action-buttons">
                    <!-- Puedes agregar un enlace a un perfil o área de usuario -->
                    <?= Html::a('Ir a tu Perfil', ['usuarios/perfil'], ['class' => 'btn btn-info']) ?>
                </div>
            <?php endif; ?>
        </div>
    </div>
