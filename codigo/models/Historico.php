...
class Historico extends \yii\db\ActiveRecord
{
    ...
    /**
     * Formatear la fecha antes de guardar en la base de datos
     */
    ...
    /**
     * Formatear la fecha después de encontrar el modelo
     */
    public function afterFind()
    {
        parent::afterFind();
        // Convertir la fecha al formato compatible con datetime-local
        $this->fecha = date('Y-m-d\TH:i', strtotime($this->fecha));
    }
}
