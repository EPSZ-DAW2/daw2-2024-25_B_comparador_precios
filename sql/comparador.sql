...
INSERT INTO `moderador` (`id`, `usuario_id`, `nif`, `nombre`, `direccion`, `region_id`, `telefono`, `razon_social`) VALUES
(6, 1, '12345678A', 'Juan Pérez', 'Calle Falsa 123', 19, '123456789', 'Moderador Juan Pérez'),
(7, 2, '87654321B', 'María García', 'Avenida Siempre Viva 456', 24, '987654321', 'Moderadora María García'),
(8, 3, '11223344C', 'Carlos López', 'Boulevard de los Sueños 789', 23, '456123789', 'Moderador Carlos López'),
(9, 4, '44332211D', 'Ana Martínez', 'Plaza Mayor 101', 20, '321654987', 'Moderadora Ana Martínez'),
(10, 5, '55667788E', 'Luis Fernández', 'Calle del Sol 202', 22, '789321456', 'Moderador Luis Fernández');
...
(0, 'Invitado', 'Usuario que no se ha registrado o iniciado sesión.'),  -- Rol por defecto
(1, 'Usuario Normal', 'Usuario regular con permisos básicos para usar la aplicación.'),
(2, 'Usuario Tienda', 'Usuario asociado a una tienda con permisos especiales.'),
(3, 'Moderador', 'Usuario con permisos para moderar contenido y gestionar usuarios.'),
(4, 'Administrador', 'Usuario con permisos para administrar el sistema y realizar tareas administrativas.'),
(5, 'Superadministrador', 'Usuario con todos los permisos, incluyendo la gestión de roles y configuraciones avanzadas.');
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `fecha_bloqueo` datetime DEFAULT NULL,
  `motivo_bloqueo` text DEFAULT NULL,
  `rol` int(11) NOT NULL DEFAULT 0,  -- 0 es 'Invitado' por defecto
  PRIMARY KEY (`id`),
...
(1, 'juan.perez@example.com', 'password123', 'juanp', 'Juan', 'Pérez', 'Calle Falsa 123', 19, '123456789', '1980-01-01', '2025-01-04 21:44:56', 1, '2025-01-04 21:44:56', 0, 0, NULL, NULL, 1),  -- Usuario Normal
(2, 'maria.garcia@example.com', 'password456', 'mariag', 'María', 'García', 'Avenida Siempre Viva 456', 21, '987654321', '1990-02-02', '2025-01-04 21:44:56', 1, '2025-01-04 21:44:56', 0, 0, NULL, NULL, 3),  -- Moderador
(3, 'carlos.lopez@example.com', 'password789', 'carlosl', 'Carlos', 'López', 'Boulevard de los Sueños 789', 20, '456123789', '1985-03-03', '2025-01-04 21:44:56', 1, '2025-01-04 21:44:56', 0, 0, NULL, NULL, 4),  -- Administrador
(4, 'ana.martinez@example.com', 'password101', 'anam', 'Ana', 'Martínez', 'Plaza Mayor 101', 24, '321654987', '1995-04-04', '2025-01-04 21:44:56', 1, '2025-01-04 21:44:56', 0, 0, NULL, NULL, 5),  -- Superadministrador
(5, 'luis.fernandez@example.com', 'password202', 'luisf', 'Luis', 'Fernández', 'Calle del Sol 202', 23, '789321456', '1975-05-05', '2025-01-04 21:44:56', 1, '2025-01-04 21:44:56', 0, 0, NULL, NULL, 1);  -- Usuario Normal
