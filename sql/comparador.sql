...
(0, 'Usuario Normal', 'Usuario regular con permisos básicos para usar la aplicación.'),
(1, 'Moderador', 'Usuario con permisos para moderar contenido y gestionar usuarios.'),
(2, 'Administrador', 'Usuario con permisos para administrar el sistema y realizar tareas administrativas.'),
(3, 'Superadministrador', 'Usuario con todos los permisos, incluyendo la gestión de roles y configuraciones avanzadas.');
...
(1, 'juan.perez@example.com', 'password123', 'juanp', 'Juan', 'Pérez', 'Calle Falsa 123', 19, '123456789', '1980-01-01', '2025-01-04 21:44:56', 1, '2025-01-04 21:44:56', 0, 0, NULL, NULL, 0), -- Usuario normal
(2, 'maria.garcia@example.com', 'password456', 'mariag', 'María', 'García', 'Avenida Siempre Viva 456', 21, '987654321', '1990-02-02', '2025-01-04 21:44:56', 1, '2025-01-04 21:44:56', 0, 0, NULL, NULL, 1), -- Moderador
(3, 'carlos.lopez@example.com', 'password789', 'carlosl', 'Carlos', 'López', 'Boulevard de los Sueños 789', 20, '456123789', '1985-03-03', '2025-01-04 21:44:56', 1, '2025-01-04 21:44:56', 0, 0, NULL, NULL, 2), -- Administrador
(4, 'ana.martinez@example.com', 'password101', 'anam', 'Ana', 'Martínez', 'Plaza Mayor 101', 24, '321654987', '1995-04-04', '2025-01-04 21:44:56', 1, '2025-01-04 21:44:56', 0, 0, NULL, NULL, 3), -- Superadministrador
(5, 'luis.fernandez@example.com', 'password202', 'luisf', 'Luis', 'Fernández', 'Calle del Sol 202', 23, '789321456', '1975-05-05', '2025-01-04 21:44:56', 1, '2025-01-04 21:44:56', 0, 0, NULL, NULL, 0); -- Usuario normal
